...
export const QuizForm = ({
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.post(`/api/courses/${courseId}/${moduleId}/chapters/${chapterId}/quizzes`, values);
  ...
  const onReorder = async (updateData: { id: string; position: number }[]) => {
    try {
      ...
      await axios.put(`/api/courses/${courseId}/${moduleId}/chapters/${chapterId}/quizzes/reorder`, {
        list: updateData
      });
